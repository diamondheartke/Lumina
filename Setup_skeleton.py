...
files = [
    ...
    "frontend/main.py",
    "frontend/scripts",
    "frontend/scripts/LoadingScreen.py",
    "frontend/scripts/TimetableScreen.py",
    "frontend/scripts/QuizScreen.py",
    "frontend/scripts/LoginScreen.py",
    "frontend/scripts/LessonScreen.py",
    "frontend/screens/LoginScreen.kv",
    "frontend/screens/LoadingScreen.kv",
    "frontend/screens/LessonScreen.kv",
    "frontend/screens/QuizScreen.kv",
    "frontend/screens/TimetableScreen.kv",
